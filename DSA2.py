...
print(binary_search(email_list, 'mgoodyear@lumonindustries.com'))  
print(binary_search(email_list, 'mark.scout@lumonindustries.com'))  

  # Checking an edge case - what if our input list is empty?

empty_list = []
print(binary_search(empty_list, 'dwight@dundermifflin.com'))      